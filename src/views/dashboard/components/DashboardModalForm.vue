    ...
    <Modal v-if="isModalVisible" class="dashboard-modal-form">
        ...
        <template v-slot:body>
            <form id="modal-form" @submit.prevent="submitForm">
                <div class="group">
                    ...
                    <input type="text" id="country" readonly v-model="indicatorToEdit.country_name">
                </div>
                <div class="group">
                    <label for="year">Year</label>
                    <input type="text" id="year" readonly v-model="indicatorToEdit.year">
                </div>
                <div class="group">
        ...
        <template v-slot:footer>
            <div class="button-container">
                <button type="button" class="button" @click="hideModal">Cancel</button>
                <button type="sumbit" form="modal-form" class="button button-submit">Save</button>
            </div>
        </template>
    </Modal>
</template>
